...
@section('content')
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                                    ...
                                    <a href="/barangexport" class="btn btn-dark me-2">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="/printbarang" class="btn btn-warning me-2">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <!--end::Export-->
                                    <a href="/satuan" class="btn btn-success me-3">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!--end::Svg Icon-->Tambah Satuan Barang
                                    </a>
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <select class="form-select form-select-solid" data-control="select2"
                                                                    ...
                                                                    @foreach ($satuan as $data)
                                                                        <option value="{{ $data->id }}" @if ($data->id == $item->satuan_id)
                                                                            @selected($data->id == $item->satuan_id)
                                                                        @endif >{{ $data->nama_satuan }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="col-md-6 fv-row">
                                    ...
                                    <div class="modal fade" id="delete{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    <!--begin:Form-->
                                                    <form id="kt_modal_new_target_form" class="form" action="{{ route('barang.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <!--begin::Heading-->
                                                    <div class="mb-13 text-center">
                                                        <!--begin::Title-->
                                                        <h1 class="mb-5">Hapus Data Barang</h1>
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
                                                        <div class="text-muted fw-semibold fs-5">
                                                            Apakah Anda yakin ingin menghapus Data Barang {{ $item->nama_barang }}? 
                                                        </div>
                                                        <!--end::Description-->
                                                    </div>
    ...
    <!--begin::Modal - New Target-->
    <div class="modal fade" id="importbarang" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('barangimport') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Import Data Barang</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('barang.store') }}" method="POST">
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-semibold mb-2">Harga Jual</label>
                                <input type="number" class="form-control form-control-solid"
                                    placeholder="Masukkan Harga Jual..." name="harga_jual" required/>
                            </div>
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-semibold mb-2">Harga Netto</label>
                                <input type="number" class="form-control form-control-solid"
                                    placeholder="Masukkan Harga Netto..." name="harga_netto" required/>
                            </div>
                        </div>
                        <div class="row g-9 mb-8">
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-semibold mb-2">Qty</label>
                                <input type="number" class="form-control form-control-solid"
                                    placeholder="Masukkan Harga Qty..." name="qty_barang" required/>
                            </div>
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-semibold mb-2">Stok</label>
                                <input type="number" class="form-control form-control-solid"
                                    placeholder="Masukkan Harga Stok..." name="stok" required/>
                            </div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8">
                            <label class="fs-6 fw-semibold mb-2">Keterangan</label>
                            <textarea class="form-control form-control-solid" rows="3" placeholder="Masukkan Keterangan..." name="ket_barang" required></textarea>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Actions-->
                        <div class="text-center">
