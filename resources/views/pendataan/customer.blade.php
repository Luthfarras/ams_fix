                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" id="carisesuatu" class="form-control form-control-solid w-250px ps-14" placeholder="Cari Data Customer..." />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                                ...
                                <a href="#" class="btn btn-secondary me-2" data-bs-toggle="modal"
                                    ...
                                    <a href="/customerexport" class="btn btn-dark me-2">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            ...
                                            data-bs-target="#editcustomer{{ $item->id }}">
                                ...
                                <div class="modal fade" id="delete{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <!--begin:Form-->
                                                <form id="kt_modal_new_target_form" class="form" action="{{ route('customer.destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <!--begin::Heading-->
                                                    <div class="mb-13 text-center">
...
<!--begin::Modal - New Target-->
<div class="modal fade" id="importcustomer" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_modal_new_target_form" class="form" action="{{ route('customerimport') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Import Data Customer</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
