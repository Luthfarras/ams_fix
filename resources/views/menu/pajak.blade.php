...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                                <!--begin::Export-->
                                <a href="#" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#cetakpajak">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="tabelumum">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Kode Laporan</th>
                                    <th class="min-w-125px">Nama Customer</th>
                                    <th class="min-w-125px">Tanggal Customer</th>
                                    <th class="min-w-125px">No. Faktur Pajak</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            ...
                                            data-bs-target="#editpajak{{ $item->id }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <!--begin:Form-->
                                                <form id="kt_modal_new_target_form" class="form" action="{{ route('pajak.destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <!--begin::Heading-->
                                ...
                                <div class="modal fade" id="editpajak{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        <!--begin::Modal content-->
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <!--begin:Form-->
                                                <form id="kt_modal_new_target_form" class="form" action="{{ route('pajak.update', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <!--begin::Heading-->
                                                    <div class="mb-13 text-center">
                                                        <!--begin::Title-->
                                                        <h1 class="mb-3">Ubah Laporan Pajak</h1>
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                            <span class="required">Kode Laporan</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                                title="Sesuaikan Kode Laporan"></i>
                                                        </label>
                                                        <!--end::Label-->
                                                        <input type="text" class="form-control form-control-solid"
                                                            placeholder="Masukkan Kode Laporan..." name="kode_laporan" value="{{ $item->kode_laporan }}" required/>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="row g-9 mb-8">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <select class="form-select form-select-solid" data-control="select2"
                                                                ...
                                                                @foreach ($customer as $data)
                                                                    <option value="{{ $data->id }}" @if ($data->id == $item->customer_id) @selected($data->id == $item->customer_id) @endif>{{ $data->nama_customer }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                        <div class="col-md-6 fv-row">
                                                            <label class="required fs-6 fw-semibold mb-2">Tanggal Customer</label>
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid"
                                                                placeholder="Masukkan No FakPajak..." name="no_fakpajak" value="{{ $item->no_fakpajak }}" required/>
                                                        </div>
                                                        <div class="col-md-6 fv-row">
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <select class="form-select form-select-solid" data-control="select2"
                                                            ...
                                                            <option value="Sudah Upload" @if($item->ket_rep == 'Sudah Upload') @selected($item->ket_rep == 'Sudah Upload') @endif>Sudah Upload</option>
                                                            <option value="Belum Upload" @if($item->ket_rep == 'Belum Upload') @selected($item->ket_rep == 'Belum Upload') @endif>Belum Upload</option>
                                                        </select>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Actions-->
    ...
    <!--begin::Modal - New Target-->
<div class="modal fade" id="cetakpajak" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body">
                <div class="ratio" style="--bs-aspect-ratio: 100%;">
                    <iframe src="/printpajak" title="Print Data Pajak"></iframe>
                </div>
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form" class="form" action="{{ route('pajak.store') }}" method="POST">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Tambah Laporan Pajak</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-muted fw-semibold fs-5">Sesuaikan dengan data yang dibutuhkan
                        </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid"
                            placeholder="Masukkan Kode Laporan..." name="kode_laporan" required/>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="row g-9 mb-8">
