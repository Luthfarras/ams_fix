...
@section('content')
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                                    <!--begin::Export-->
                                    <a href="#" class="btn btn-warning me-2 dropdown-toggle" id="dropdownMenuButton1"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        @for ($i = 2022; $i <= $now; $i++)
                                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                    data-bs-target="#cetakpenjualan{{ $i }}">{{ $i }}</a>
                                            </li>
                                        @endfor
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                            data-bs-target="#cetakpenjualan">Cetak Semua</a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                        ...
                                                        <form id="kt_modal_new_target_form" class="form"
                                                            ...
                                                            <div class="image-responsive text-center">
                                                                <img src="{{ asset('met/dist/assets/media/illustrations/6969.png') }}"
                                                                    width="250px" alt="" srcset="">
                                                            </div>
                                                            <!--end::Heading-->
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered ">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-header">
                    <div class="p">
                        Tekan <span class="badge bg-info"><i class="fa-solid fa-download fa-inverse"></i></span> untuk
                        mengunduh Data
                    </div>
                    <div class="p">
                        Tekan <span class="badge bg-success"><i class="fa-solid fa-print fa-inverse"></i></span> untuk
                        mencetak data
                    </div>
                </div>
                <!--begin::Modal body-->
                <div class="modal-body">
                    <div class="ratio" style="--bs-aspect-ratio: 100%;">
                        <iframe src="/printpenjualan/0" title="Print Data Barang"></iframe>
                    </div>
    ...
    <!--begin::Modal - New Target-->
    @for ($i = 2022; $i <= $now; $i++)
        <div class="modal fade" id="cetakpenjualan{{ $i }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-lg modal-dialog-centered ">
                <!--begin::Modal content-->
                <div class="modal-content rounded">
                    ...
                    <div class="modal-body">
                        <div class="ratio" style="--bs-aspect-ratio: 100%;">
                            <iframe src="/printpenjualan/{{ $i }}" title="Print Data Barang"></iframe>
                        </div>
                        <div class="h4 mt-3 text-center">
                            Pastikan data sudah benar. Mohon diperiksa kembali sebelum dicetak
                        </div>
