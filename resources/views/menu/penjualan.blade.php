        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Laporan Penjualan</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                @if (Auth::user()->role == 'Owner')
                                                    <a href="status/{{ $item->id }}" class="menu-link px-3">Ganti Status</a>
                                                @endif
                                            </div>
                                            @endif
                                        </div>
                            ...
                            <tfoot>
                                <tr class="text-start text-muted fw-bold fs-7 gs-0">
                                    ...
                                    <th class="min-w-125px">JUMLAH</th>
                                    <th class="min-w-125px"></th>
                                    <th class="min-w-125px"><span class="badge bg-primary">Rp. {{ number_format($jumlah,0,",",".") }}</span></th>
                                    <th class="min-w-125px"></th>
                                    <th class="min-w-125px"></th>
