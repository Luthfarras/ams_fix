                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    @foreach ($setoran as $item)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('storage/' . $item->foto_dep) }}" width="100px"
                                                    alt="" srcset=""></td>
                                            <!--end::Product=-->
                                            <!--begin::Date=-->
                                            <td>{{ $item->ket_dep }}</td>
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="" class="menu-link px-3" data-bs-toggle="modal"
                                                            data-bs-target="#editsetoran{{ $item->id }}">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="setoran/{{ $item->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content rounded">
                                                    ...
                                                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                        <!--begin:Form-->
                                                        <form id="kt_modal_new_target_form" class="form" action="{{ route('setoran.update', $item->id) }}"
                                                            ...
                                                            <div class="mb-13 text-center">
                                                                <!--begin::Title-->
                                                                <h1 class="mb-3">Ubah Data Setoran</h1>
                                                                <!--end::Title-->
                                                                <!--begin::Description-->
                                                            ...
                                                            <div class="d-flex flex-column mb-8 fv-row">
                                                                ...
                                                                <input type="text" class="form-control form-control-solid"
                                                                    placeholder="Masukkan Kode Setoran..." name="kode_dep" value="{{ $item->kode_dep }}"/>
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="row g-9 mb-8">
                                                                ...
                                                                <div class="col-md-6 fv-row">
                                                                    ...
                                                                    <select class="form-select form-select-solid" data-control="select2"
                                                                        data-hide-search="true" data-placeholder="Pilih Satuan Barang..." name="customer_id">
                                                                        <option selected disabled>Pilih Nama Customer...</option>
                                                                        @foreach ($customer as $data)
                                                                            <option value="{{ $data->id }}" @if ($data->id == $item->customer_id)
                                                                                @selected($data->id == $item->customer_id)
                                                                            @endif>{{ $data->nama_customer }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <!--end::Col-->
                                                            ...
                                                            <div class="row g-9 mb-8">
                                                                <div class="col-md-6 fv-row">
                                                                    ...
                                                                    <input type="number" class="form-control form-control-solid"
                                                                        placeholder="Masukkan Jumlah Masuk..." name="jumlah_masuk" value="{{ $item->jumlah_masuk }}"/>
                                                                </div>
                                                                <div class="col-md-6 fv-row">
                                                                    <label class="required fs-6 fw-semibold mb-2">Jumlah Keluar</label>
                                                                    <input type="number" class="form-control form-control-solid"
                                                                        placeholder="Masukkan Jumlah Keluar..." name="jumlah_keluar" value="{{ $item->jumlah_keluar }}" />
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-column mb-8 fv-row">
                                                                <!--begin::Col-->
                                                                <label class="required fs-6 fw-semibold mb-2">Foto</label>
                                                                <input type="file" class="form-control form-control-solid" placeholder="Masukkan Foto..."
                                                                    name="foto_dep" />
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="d-flex flex-column mb-8">
                                                                ...
                                                                <textarea class="form-control form-control-solid" rows="3" name="ket_dep"
                                                                    placeholder="Masukkan Keterangan...">{{ $item->ket_dep }}</textarea>
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Actions-->
    ...
    <div class="modal fade" id="kt_modal_new_target" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('setoran.store') }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--begin::Datepicker-->
                                    <input id="due_date" class="form-control form-control-solid ps-12"
                                        placeholder="Select a date" name="tanggal_dep" />
                                    <!--end::Datepicker-->
                                </div>
                            </div>
                            <!--end::Col-->
