            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form" class="form" action="" method="POST">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Tambah Faktur</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Kode Invoice</span>
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                title="Pilih Kode Invoice"></i>
                        </label>
                        <!--end::Label-->
                        <select class="form-select form-select-solid" data-control="select2"
                                data-hide-search="true" data-placeholder="Pilih Kode Invoice..."
                                name="kode_faktur" id="reset-select" required>
                                <option selected value="">Pilih Invoice...</option>
                                @foreach ($detail as $item)
                                    <option value="{{ $item->id }}">{{ $item->kode_faktur }}</option>
                                @endforeach
                            </select>
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Total Harga...." name="total_harga" disabled />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Tanggal Invoice</label>
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <!--end::Icon-->
                                <!--begin::Datepicker-->
                                <input type="text" id="due_date" class="form-control form-control-solid ps-12" name="tanggal_faktur" placeholder="Select a date" required/>
                                <!--end::Datepicker-->
                            </div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">PPN</label>
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Masukkan PPN...." name="ppn" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">PPH</label>
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Masukkan PPH...." name="pph"  />
                        </div>
                        <!--end::Col-->
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <!--begin::Label-->
                        <label class="required fs-6 fw-semibold mb-2">Total Final</label>
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Total Final..." name="total_pp"  />
                    </div>
                    <div class="d-flex flex-column mb-8">
                        <label class="fs-6 fw-semibold mb-2">Keterangan</label>
                        <textarea class="form-control form-control-solid" rows="3" placeholder="Masukkan Keterangan..." name="ket_faktur"></textarea>
                    </div>
