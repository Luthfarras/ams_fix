                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $user->username }}</a>
                                        </div>
                                        <!--end::Name-->
                                        <!--begin::Info-->
                                    ...
                                    <div class="d-flex my-4">
                                        @if (DB::table('detail_profils')->where('user_id', Auth::user()->id)->exists())
                                        <a href="#" class="btn btn-sm btn-success me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Edit Detail Profil</a>
                                        @else
