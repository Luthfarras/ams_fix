        ...
        @if (DB::table('detail_profils')->where('user_id', Auth::user()->id)->exists())
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex align-items-center flex-grow-1">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="text-gray-400 fw-bold">{{ $item->tanggal }}</span>
                                            ...
                                            <div class="my-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <div class="menu-content fs-6 text-dark fw-bold px-3 py-4">Aksi
                                                            Cepat</div>
                                                    </div>
                                                    <!--end::Menu item-->
                    ...
                    {{-- <div class="modal fade" id="editcatatan{{ $item->id }}" tabindex="-1" aria-hidden="true">
                        <!--begin::Modal dialog-->
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content rounded">
                                ...
                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                    <!--begin:Form-->
                                    <form id="kt_modal_new_target_form" class="form" action="{{ route('notes.update', $item->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <!--begin::Heading-->
                                        <div class="mb-13 text-center">
                                            <!--begin::Title-->
                                            <h1 class="mb-3">Ubah Catatan</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                ...
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Sesuaikan Judul catatan"></i>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control-solid" placeholder="Masukkan Judul Catatan..." name="judul" value="{{ $item->judul }}" required/>
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-column mb-8">
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <!--end::Icon-->
                                                <!--begin::Datepicker-->
                                                <input type="text" id="tanggalisi2" class="form-control form-control-solid ps-12 mb-2" placeholder="Pilih Tanggal" name="tanggal" value="{{ $item->tanggal }}" required/>
                                        </div>
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-column mb-8">
                                            <label class="fs-6 fw-semibold mb-2">Isi Catatan</label>
                                            <textarea class="form-control form-control-solid" rows="3" placeholder="Masukkan Isi Catatan" name="isi" required>{{ $item->isi }}</textarea>
                                        </div>
