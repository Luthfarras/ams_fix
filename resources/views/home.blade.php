            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form" class="form" action="{{ route('notes.store') }}" method="POST">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Masukkan Judul Catatan..." name="judul" required/>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8">
                        ...
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <!--end::Icon-->
                            <!--begin::Datepicker-->
                            <input type="text" id="tanggalisi2" class="form-control form-control-solid ps-12 mb-2" placeholder="Pilih Tanggal" name="tanggal" required/>
                    </div>
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8">
                        <label class="fs-6 fw-semibold mb-2">Isi Catatan</label>
                        <textarea class="form-control form-control-solid" rows="3" placeholder="Masukkan Isi Catatan" name="isi" required></textarea>
                    </div>
